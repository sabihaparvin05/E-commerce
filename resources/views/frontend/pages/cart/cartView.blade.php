    ...
    <div class="row d-flex justify-content-center align-items-center h-100" style="margin-top: 100px;">
      <div class="col-10">
              ...
              <div class="card-body p-4">
                <div class="row d-flex justify-content-between align-items-center">
                  <div class="col-md-2 col-lg-2 col-xl-2">
                    <img src="{{ url('/uploads/'.$cartItem['image']) }}" class="img-fluid rounded-3" alt="">
                  </div>
                  ...
                  <div class="col-md-2 col-lg-2 col-xl-2 text-end">
                    <a href="{{ route('delete.cart', ['productId' => $cartItem['id']]) }}" class="btn btn-danger">Delete</a>
                  </div>
                </div>
              </div>
            </div>
        ...
        @if(!empty(session('cart')))
          <div class="card">
            <div class="card-body">
              <a href="{{route('checkout.view')}}" type="button" data-mdb-button-init data-mdb-ripple-init class="btn btn-warning btn-block btn-lg">Checkout</a>
            </div>
          </div>
        @endif
